                ...
                <Layout style={ styles.selfContent }>
                    <Layout>
                        <Image
                            ...
                            source={ require('../../images/items/item_photo5.jpeg') } 
                        />
                    </Layout>
                    <Layout style={ styles.selfContentInfo }>
                        <Layout style={ styles.selfContentBody }>
                            <Text style={ styles.selfContentTitle } >Brandi Carcile Bear Greek</Text>
                            <Text style={ styles.selfContentSubtitle }>2019, Abdul Malik</Text>
                        </Layout>
                        <Text style={ styles.selfContentLabel }>Borrowed By:</Text>
